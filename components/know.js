...
const Know = () => {
  ...
  useEffect(() => {
    ...
    gsap.fromTo(section.querySelector('.adi-img'), 
      { opacity: 0, y: -80,x:0 }, 
      { opacity: 1, y: 0,x:0, duration: 1, scrollTrigger: {
        trigger: section,
        start: 'top 80%',
        end: 'top 48%',
        scrub: true,
    ...
    gsap.fromTo(section.querySelector('.adi-img'), 
      { opacity: 0, x: 0, y: 0 }, 
      { opacity: 1, x: -185, y: 300, duration: 1, scrollTrigger: {
        trigger: section,
        start: 'top 48%',
        end: 'top 18%',
        scrub: true,
    ...
    gsap.fromTo(section.querySelector('.adi-img'), 
      ...
      { opacity: 1, y: 500,x: 0, duration: 1, scrollTrigger: {
        trigger: section,
        start: 'top 16%',
        end: 'top 2%',
        scrub: true,
    ...
    ScrollTrigger.create({
        ...
        onEnter: () => {
          ...
          scrambleText(element, "what i know?", 60); // 60 frames for 1 second
        }
      });
  }, []);
  ...
  return (
    <section >
      ...
      <div ref={sectionRef} className='grid grid-cols-2 space-x-2 space-y-2 h-screen py-2 px-2'>
        ...
        <div className='bg-[#877c73] rounded-l-2xl rounded-e-md'><h1 className='text-5xl font-serif p-3'> Other</h1>
